...
public class DeviceUtils {
    ...
    public static boolean isM7Device(Context con) {
        return con.getResources().getBoolean(R.bool.is_htc_one);
    }
    public static boolean isSamsungDevice(Context con) {
        return con.getResources().getBoolean(R.bool.is_samsung);
    }
